...
// Consumer failure receipt status values — see R-03 (ZORD_Intent_Engine
// Remaining_Non_Evidence_Fixes_Developer_Action_Document, 2026-07-20).
const (
...
type ConsumerFailureReceipt struct {
	...
	Payload     []byte `json:"-"` // never serialized into API responses; replay source only
