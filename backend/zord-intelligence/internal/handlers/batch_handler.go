...
type predictionAuthority struct {
...
type batchContractResponse struct {
	...
	PredictedLeakageAdvisory        *predictionAuthority `json:"predicted_leakage_advisory,omitempty"`
...
func newBatchContractResponse(b persistence.BatchContract, internalUUID *string) batchContractResponse {
	...
	var predictionAdvisory *predictionAuthority
	if b.PredictedLeakageModelID != nil {
		predictionAdvisory = &predictionAuthority{
			OutputKind:                "ADVISORY_PREDICTION",
	...
	return batchContractResponse{
		...
		PredictedLeakageAdvisory:        predictionAdvisory,
