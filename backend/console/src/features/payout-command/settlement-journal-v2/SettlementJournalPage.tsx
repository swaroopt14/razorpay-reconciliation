...
import { SettlementJournalSurface } from './SettlementJournalSurface'

/** Spec 7.11 route shell - `/settlement/journal`. */
export function SettlementJournalPage() {
