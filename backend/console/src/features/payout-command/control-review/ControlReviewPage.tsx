...
import { ControlReviewSurface } from './ControlReviewSurface'

/** Spec 7.7 route shell - `/controls/review`. */
export function ControlReviewPage() {
    ...
    <EnvironmentProvider routeMode="sandbox">
      ...
      >
        <div className={PAYOUT_CONSOLE_CARD_CLASS}>
          ...
          >
            <section className="relative flex-1 p-0 sm:p-0 lg:p-0">
              <PayoutPageActionsProvider>
                <ControlReviewSurface />
              </PayoutPageActionsProvider>
            </section>
          </PayoutConsoleNavStack>
        </div>
