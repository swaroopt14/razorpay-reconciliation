...
export const SANDBOX_OUTCOME_PATH = '/settlement/review?demo=sandbox&gap=short_settled&focus=PAY-0019'
...
export const SANDBOX_SETUP_GUIDE = {
  ...
  steps: [
    ...
    },
    {
      ...
      detail:
        'PAY-0019 - sealed contract vs observed credit; unexplained delta. AI may explain; match stays deterministic.',
  ...
  notes: [
    ...
    `Primary batch: ${DEMO_SMOKE_BATCH_ID} (20 payouts: 17 exact · 1 blocked · 1 short · 1 return)`,
