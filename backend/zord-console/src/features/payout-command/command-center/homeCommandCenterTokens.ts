...
/** Outer page wash - flush console, no black inset frame. */
export const PAYOUT_PAGE_BG_CLASS = 'bg-[#FFFFFF]'
/** Carousel / command cool blue - same token used on Leakage & Ambiguity pages. */
export const COMMAND_COOL_PAGE_BG = 'bg-[#F8FAFC]'
/** Whitish minimal warm beige - Home command band + Batch body. */
export const PAYOUT_WARM_SURFACE_BG_CLASS = 'bg-[#F8FAFC]'
/** Console shell host - edge-to-edge; DockNav owns layout. */
export const PAYOUT_CONSOLE_CARD_CLASS = 'w-full min-h-[100dvh] bg-[#FFFFFF]'
