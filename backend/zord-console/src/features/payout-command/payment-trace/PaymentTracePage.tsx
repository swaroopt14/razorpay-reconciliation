...
import { PaymentTraceSurface } from './PaymentTraceSurface'

/** Spec 7.10 route shell - `/payments/:id/trace`. */
export function PaymentTracePage({ paymentId }: { paymentId?: string }) {
          ...
          >
            <section className="relative flex-1 p-0">
              <PayoutPageActionsProvider>
                <PaymentTraceSurface paymentId={paymentId} />
              </PayoutPageActionsProvider>
            </section>
          </PayoutConsoleNavStack>
        </div>
