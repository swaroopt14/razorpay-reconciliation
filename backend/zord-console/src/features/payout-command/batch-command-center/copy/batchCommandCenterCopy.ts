...
export const BATCH_REVIEW_COPY = {
  ...
  intake: {
    ...
    step2Helper:
      'Bank statement, settlement report, status file, or SFTP export used to confirm payment outcomes. Same reprocess control as Step 1 — force stays off until you confirm why.',
  ...
  fields: {
    ...
    reprocessHelper: 'Opens a prompt to choose payment instruction or settlement, and why you need to reprocess.',
  ...
  dialogs: {
    ...
    reprocessWhyBody:
      'Choose whether this applies to the payment instruction file or the bank confirmation file, then pick a reason.',
    reprocessTargetLegend: 'Reprocess',
    reprocessTargetIntent: 'Payment instruction file',
    reprocessTargetSettlement: 'Bank / settlement confirmation file',
