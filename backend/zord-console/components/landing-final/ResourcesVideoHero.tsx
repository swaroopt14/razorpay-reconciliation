...
const VIDEO_SRC = '/final-landing/resources/resources-nature-hero.mp4'

export function ResourcesVideoHero() {
        ...
        <div className="mx-auto flex w-full max-w-[1440px] flex-col gap-10 lg:flex-row lg:items-end lg:justify-between">
          ...
          >
            <div className="min-w-0">
              <p className="text-[11px] font-semibold uppercase tracking-[0.18em] text-white/65">Resource map</p>
              <p className="mt-1 truncate text-[15px] font-semibold tracking-[-0.02em]">Scroll to all resources</p>
            </div>
