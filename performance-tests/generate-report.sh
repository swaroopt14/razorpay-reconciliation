...
**Grafana:** [Platform Health Dashboard](http://localhost:3001/d/zord-platform-health)
...
- [x] CORS preflight for localhost
...
- **Grafana:** http://localhost:3001/d/zord-platform-health
