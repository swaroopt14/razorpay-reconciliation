...
Tracked plan: [PHASE6_PLAN.md](./docs/PHASE6_PLAN.md).
...
Tracked plan: [PHASE7_PLAN.md](./docs/PHASE7_PLAN.md).
...
Tracked plan: [PHASE8_PLAN.md](./docs/PHASE8_PLAN.md).
...
Tracked plan: [PHASE9_PLAN.md](./docs/PHASE9_PLAN.md).
...
Tracked plan: [PHASE11_PLAN.md](./docs/PHASE11_PLAN.md).
...
- [x] Ask Zord / Finance RAG — [PHASE8_PLAN.md](./docs/PHASE8_PLAN.md)
- [x] Investigation agent (hypothesis loop) — [PHASE9_PLAN.md](./docs/PHASE9_PLAN.md)
- [x] Evaluation harness (100+ labeled records, real metrics) — [PHASE11_PLAN.md](./docs/PHASE11_PLAN.md)
